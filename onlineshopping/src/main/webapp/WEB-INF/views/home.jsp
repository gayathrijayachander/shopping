					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="${images}/car1.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/car2.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/car3.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/car4.jpg"
									alt="">
							</div>
						</div>
